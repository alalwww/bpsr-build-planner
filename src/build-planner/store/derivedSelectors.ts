...
export const selectRawStatsResult = memoize1(
  (
    ...
    battleImaginaries: CalculateRawStatsInput['battleImaginaries'],
    imaginaryRanks: CalculateRawStatsInput['imaginaryRanks'],
...
export const selectAbilityScore = memoize1(
  (
    ...
    battleImaginaries: CalculateAbilityScoreInput['battleImaginaries'],
    imaginaryRanks: CalculateAbilityScoreInput['imaginaryRanks'],
...
export function computeStatsBundle(state: BuildStore): StatsBundle {
  ...
  const rawStatsResult = selectRawStatsResult(
    ...
    talentNodesById,
    r1NodeCount,
    state.battleImaginaries,
    state.imaginaryRanks,
    state.slotEnchants,
    state.moduleSlots,
